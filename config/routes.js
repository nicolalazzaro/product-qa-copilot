...
module.exports.routes = {
  ...
  "GET /shops": { action: "shop/view-index-shop" },
  "GET /shops/new": { action: "shop/view-new-shop" },

  "GET /shops/:shop/products": { action: "product/view-index-product" },
  "GET /shops/:shop/products/new": { action: "product/view-new-product" },

  "GET /generate-qa": { action: "view-generate-qa" },
  ...
  "POST /api/v1/shops": { action: "shop/store-shop" },

  "POST /api/v1/products": { action: "product/store-product" },

  "GET /api/v1/scrape-product": { action: "scrape-product" },

  "GET /api/v1/generate-qa": { action: "generate-qa" },
};
