...
Cloud.setup({
  ...
  methods: {
    ...
    storeShop: {
      verb: "POST",
      url: "/api/v1/shops",
      args: ["name", "productNameDomSelector", "productDescriptionDomSelector"],
    },
    storeProduct: {
      verb: "POST",
      url: "/api/v1/products",
      args: ["url", "name", "description", "shop"],
    },
    scrapeProduct: {
      verb: "GET",
      url: "/api/v1/scrape-product",
      args: ["shop", "url"],
    },
    generateQa: { verb: "GET", url: "/api/v1/generate-qa", args: [] },
  },
  /* eslint-enable */
});
